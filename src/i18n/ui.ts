...
export const ui = {
  ...
  ar: {
    ...
    'site.description':
      'الوصفة الذكية شركة تقنية معلومات تقدم حلولاً برمجية مدعومة بالذكاء الاصطناعي تجعل حياتك اليومية أفضل وأسهل وأسرع.',

    'nav.about': 'من نحن',
    'nav.products': 'منتجاتنا',
    'nav.why': 'لماذا الوصفة الذكية',
    'nav.contact': 'تواصل معنا',
    'nav.langSwitch': 'English',

    'hero.eyebrow': 'الوصفة الذكية',
    ...
    'about.title': 'من نحن',
    'about.body':
      'في الوصفة الذكية، نؤمن بأن التقنية يجب أن تعمل من أجلك، لا أن تزيد حياتك تعقيداً. نبني حلولاً ذكية مدعومة بالذكاء الاصطناعي تُبسّط تفاصيل يومك وتفتح أمامك آفاقاً جديدة — عبر مزج الهندسة البرمجية المدروسة بأحدث ما توصّل إليه الذكاء الاصطناعي، لنصنع منتجات توفّر وقتك، وتقلّل جهدك، وتُحسّن أسلوب حياتك وعملك.',
    ...
    'products.yelga.name': 'يلقا',
    'products.yelga.tag': 'اعثر على أي شيء على الويب في لحظة.',
    'products.yelga.body':
      'يلقا تطبيق بحث ذكي يجد ما تبحث عنه عبر الويب في ثوانٍ. بدلاً من البحث الطويل، يعتمد يلقا على الذكاء الاصطناعي لفهم ما تحتاجه فعلاً وتقديمه إليك مباشرة — أسرع طريق من السؤال إلى الإجابة.',

    'why.title': 'لماذا الوصفة الذكية',
